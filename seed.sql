...
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (1, 1, NULL, 'Mercury', 1, NULL, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (2, 1, NULL, 'Venus', 2, NULL, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (2, 1, NULL, 'Venus', 2, 0.904, 1, 2018.3);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (3, 1, 1, 'Earth', 3, 0.99, 1, 2018.1);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (3, 1, 1, 'Earth', 3, 1, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (4, 1, NULL, 'Mars', 4, NULL, 1, 2018.3);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (5, 1, NULL, 'Jupiter', 6, NULL, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (6, 1, NULL, 'Saturn', 7, NULL, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (7, 1, NULL, 'Uranus', 8, NULL, 1, 2018.2);
insert into planet_report (planet_id, star_system_id, owner_id, name, position, gravity, user_id, date) values (8, 1, NULL, 'Neptune', 9, NULL, 1, 2018.2);
...
insert into building (planet_id, type, level, construction, damage) values (3, 'SensorStation', 1, 1.0, 1.0);
insert into building (planet_id, type, level, construction, damage) values (3, 'ResearchComplex', 1, 1.0, 1.0);
insert into building (planet_id, type, level, construction, damage) values (3, 'ResearchComplex', 1, 0.5, 0.5);
